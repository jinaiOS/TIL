...
public class Main {
    public static void main(String[] args) {
        ...
        orders.add(new Order(1001, customer1, "2023-11-09", OrderStatus.PAID, orderItems1));
        orders.add(new Order(1002, null, "2023-11-09", OrderStatus.SHIPPED, orderItems2));
        orders.add(new Order(1003, customer3, "2023-11-09", OrderStatus.SHIPPED, orderItems2));
        orders.add(new Order(1004, customer2, "2023-11-09", OrderStatus.ON_ORDER, null));
        orders.add(new Order(1005, customer4, "2023-11-09", OrderStatus.NOT_PAID, null));
        orders.add(new Order(1006, customer1, "2023-11-09", OrderStatus.SHIPPED, orderItems2));
